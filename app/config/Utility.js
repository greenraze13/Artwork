...
Utility.deviceId = ""
Utility.getUserId = () =>
  Utility.user != undefined ? Utility.user.user_id + "" : "0"
...
Utility.toggleSideMenu = function() {
  ...
  DeviceEventEmitter.emit("sideMenuViewWillToggleNotification", {
    isVisible: false
  })
}
...
Utility.getDateMMMdd = function prettyDate(mili) {
  ...
  return months[date.getMonth()] + " " + date.getDate() //MMM dd
...
Utility.isToday = function checkIsToday(mili) {
  ...
  var isToday =
    currentDate.toDateString() == messageDate.toDateString() ? true : false
  return isToday
}
...
Utility.MESSAGES = {
  ...
  message_sent:
    "Your message has been sent to the artist. Check your message inbox for the response",
  please_enter_valid_phone: "Please enter valid phone number",
  please_enter_password: "Please enter password",
  login_cancelled: "Login cancelled",
  //Home
  location_alert:
    "Please enable your location for you to browse nearby Artists and Artworks.",
  ...
  please_enter_businessname: "Please enter business name",
  ...
  please_enter_your_town: "Please enter your town",
  artist_request_successfully: "Artist request successful.",
  now_you_are_artist: "Congratulations! Now you are Artist.",
  please_select_banner_project: "Please select the banner for the project",
  please_complete_your_profile: "Please complete your Profile",
  please_select_your_profile_image: "Please select your profile image",
  //Artist Profile View
  ...
  subscription_expired:
    "Your free trail/subscription period has been expired. Please get subscription for use this functionality.",
  please_enter_variants_price: "Please enter price(s) for variants.",
  please_add_variants: "Please add variants."
}
...
Utility._checkWriteStoragePermission = function() {
  ...
  const rationale = {
    ...
    message:
      "Allow Loc Art to access to photos, media and files on your device."
  }
  return PermissionsAndroid.request(
...
Utility.updateSwipeViewStatus = function updateSwipeViewStatus(whichView) {
  // WebClient.postRequest(Settings.URL.UPDATE_VISITED_LIST, {
  //   'whichView': whichView + '',
  ...
  User.saveAsyncData(whichView, "true")
}
