...
class MessageToArtistViewController extends Component {
    constructor(props) {
        super(props);
    ...
    getChatMessages(messageOrder, isRecent, showLoading, resetMessageList) {
        ...
        dictParam.artwork_id = this.props.artwork_id + ''
        ...
        WebClientChat.postRequest(Settings.URL.GET_CHAT_LIST_WITH_ARTIST, dictParam, (response, error) => {
    ...
    sendAttachmentAPI(serverImageName) {
        ...
        dictParam.is_custom_job_chat = 1
        dictParam.artwork_id = this.props.artist_id
        dictParam.commission_request_id = this.state.commissionRequestId
