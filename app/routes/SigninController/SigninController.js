...
class SigninController extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isRememberme: true,
            // phoneNumber: "4083728089",
            // phoneNumber: "8318180423",
            // password: "jason_wang",
            phoneNumber: '',
            password: '',
    ...
    signIn() {
        ...
        console.log("signin() :: device_token = " + this.state.deviceToken);
    ...
    tryAppleSignIn = async () => {
        ...
        try {
            ...
            context.socialLoginAPI(user, 'apple');
        } catch (error) {
            if (error.code === AppleAuthError.CANCELED) {
                Utility.showToast(Utility.MESSAGES.login_cancelled);
                console.warn('User canceled Apple Sign in.');
            } else {
                Utility.showToast(Utility.MESSAGES.unknown_error);
            }
        }
    };
