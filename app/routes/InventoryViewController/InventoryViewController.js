...
class InventoryViewController extends Component {
    ...
    btnPastOrderClick() {
        if (this.state.arrListedArtworks.length > 0) {
    ...
    getListedArtworks() {
        ...
        if (this.state.arrListedArtworks.length > 0) {
            Utility.updateSwipeViewStatus('inventoryView');
        }
    }
    ...
    renderListedArtworksViewCell(rowData, secId, rowId, rowMap) {
        ...
        return (
            <SwipeRow
                ...
                leftOpenValue={150}
                rightOpenValue={-150}
                preview={(position == 0 && !visited.inventoryComponentListed) ? true : false}        // added by Wang
                previewOpenValue={-150}                         // added by Wang
            >
    ...
    renderSoldArtworksViewCell(rowData, secId, rowId, rowMap) {
        ...
        /************ added by Wang - start  ***********/
        var disableRightSwipeFlag = (soldArtworks.order_status_id == Utility.OrderStatus.COMPLETED
        ...
        var disableLeftSwipeFlag = (soldArtworks.order_status_id == Utility.OrderStatus.COMPLETED
            || soldArtworks.order_status_id == Utility.OrderStatus.CANCELLED
            || soldArtworks.order_status_id == Utility.OrderStatus.NONE) ? true : false;
        /************ added by Wang - end  *************/
