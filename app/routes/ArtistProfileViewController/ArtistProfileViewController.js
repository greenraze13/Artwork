...
import { Text, View, Platform, Image, TouchableOpacity, FlatList, StyleSheet } from 'react-native';
...
class ArtistProfileViewController extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            town: Utility.user != undefined ? Utility.user.town : "",
            state_code: "",
            zipcode: Utility.user != undefined ? Utility.user.zipcode : "",
            full_name: Utility.user != undefined ? Utility.user.full_name : "",
            businessName: Utility.user != undefined ? Utility.user.businessName : "",
    ...
    componentDidMount() {
        if(Utility.user.bio =="" && this.props.isFromArtistPortal != true) {
            Utility.showToast(Utility.MESSAGES.please_complete_your_profile)
        }
    ...
    leftBtnTaaped() {
        ...
        } else if (this.props.isFromArtistPortal) {
    ...
    saveArtistTapped() {
        ...
        } else if(this.state.preferred_medium_id == "") {
        ...
        } else if (this.state.town.trim() == "") {
            Utility.showToast(Utility.MESSAGES.please_enter_your_town)
        } else if (this.state.bio.trim() == "") {
            Utility.showToast(Utility.MESSAGES.please_describe_your_artwork)
        } else if ((this.state.photoIDUrlCover == undefined) && (Utility.user.profile_banner_photo.trim() == "")) {
            Utility.showToast(Utility.MESSAGES.please_select_banner_project)
        } else if ((this.state.photoIDUrl == undefined) && (Utility.user.profile_pic.trim() == "")) {
            Utility.showToast(Utility.MESSAGES.please_select_your_profile_image)
    ...
    render() {
        var warning = <ModalBox 
            style={[warningStyles.modal, warningStyles.modal2, (Utility.screenHeight <= 570) ? {height: 180} : {height:150}]} 
            swipeToClose={false} 
            ...
            <Text style={[warningStyles.text]}>
                Please fill out your artist profile info and then scroll down to the bottom and tap save.
            </Text>
        ...
        var stateModelbox = <ModalBox
            ...
            <View style={{ flex: 1, paddingHorizontal: 10 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity onPress={this.statePopUpClose.bind(this)} activeOpacity={0.7}>
        ...
        return (//onPress={Utility.hideKeyboard()}
            <View style={styles.container}>
                {
                    (this.props.isFromArtistPortal == true) ? warning : null
                }
                <SafeAreaView style={styles.surfaceView}>
                    <View style={styles.topViewStyle}>
                    {
                        (this.props.isFromArtistPortal != true) ?
                        ...
                        :
                            <TouchableOpacity style={styles.emptyTitleView}>
                            </TouchableOpacity>
                    }

                        <View style={[styles.profilePicView, {borderColor: Colors.black}]}>
                    ...
                    <KeyboardAwareScrollView extraScrollHeight={100}
                        ...
                        <View style={{ marginTop: 5 }}>
                            ...
                            <View style={[styles.titleContainerLeft, { marginTop: 10 }]}>
                                <Text style={styles.titleStyle}>Business Name (Optional)</Text>
                                {
                                    <TextField
                                        inputStyle={styles.inputText}
                                        placeholderTextColor={Colors.grayTextColor}
                            ...
                            <TouchableOpacity style={{ marginVertical: 25 }} onPress={() => this.btnSelectImageTapped(COVER_PHOTO, 0)}>
                                <View style={styles.bannerProjectContainer}>
                                    {((this.state.photoIDUrlCover != undefined) || (Utility.user != undefined && Utility.user.profile_banner_photo != "")) ?
                                        <ProgressiveImage
                                            style={{
                                            ...
                                            uri={(this.state.photoIDUrlCover != undefined) ? this.state.photoIDUrlCover : Utility.user != undefined ? Utility.user.profile_banner_photo : undefined}
