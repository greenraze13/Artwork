...
class SubscriptionViewController extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            featuresList: [
                ...
                { name: 'Transfer profits directly into your bank account' },
            ]
        };
    }
    ...
    btnTermsTapped() {
        Utility.push('TermsViewController');
    }

    btnPrivacyTapped() {
        Utility.push('PolicyViewController');
    }
                    ...
                    <KeyboardAwareScrollView
                        ...
                        <View style={{ marginTop: 10, flex: 1 }}>
                            <View style={{ marginHorizontal: 5 }}>
                                {this.state.subscription_type != Utility.SUBSCRIPTION_TYPE.NOT_SUBSCRIBE ?
                                    <View>
                                        <Text style={styles.txtDateTitle}>{this.state.subscription_type == Utility.SUBSCRIPTION_TYPE.FREE_TRIAL ? "Free Trial" : "Subscription"} Expires on</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                            <INTButton buttonStyle={styles.btnChekout}
                                ...
                                onPress={() => this.btnTermsTapped()} />
                            <Text>&nbsp;&nbsp;&nbsp;</Text>
                            <INTButton buttonStyle={styles.btnChekout}
                                title="Privacy policy"
                                titleStyle={styles.titleCheckout}
                                spaceBetweenIconAndTitle={0}
                                onPress={() => this.btnPrivacyTapped()} />
                        </View>
                    </KeyboardAwareScrollView>
                    {
                        this.state.subscription_type == Utility.SUBSCRIPTION_TYPE.NOT_SUBSCRIBE ?
