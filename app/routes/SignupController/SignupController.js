...
class SignupController extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            // full_name: "Wang",
            // email: "jason.nb.wang@gmail.com",
            // phone: "4083728089",
            // password: "jason_wang",
            // confirmPassword: "jason_wang",
            full_name: __DEV__ ? "John": "",
            email: __DEV__ ? "jennis@gmail.com":"",
            phone: __DEV__ ? "9409229779":"",
            password: __DEV__ ? "pass123":"",
            confirmPassword: __DEV__ ? "pass123":"",
            country_code: "",
    ...
    preSignUP() {
        ...
        WebClient.postRequest(Settings.URL.PRE_SIGNUP, {
            ...
            // alert('here opening verification');
            if (error == null) {
                this.openMobileVerificationView()
            } else {
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                {/* <Modal visible={this.state.showVerifyMobile}>
                    <MobileVerificationController 
                        phone={this.state.phone} 
                        countryCode={this.state.country_code}
                        visible={this.state.showVerifyMobile}
                        onCancel={() =>this.closeMobileVerificationView()}
                        onComplete={this.onVerificationComplete}
                    />
                </Modal> */}
